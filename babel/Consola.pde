...
public final class Consola{
  ...
  public Consola(){
    ...
    tamanoTexto = 10;//int( height * 0.013 ); //int( height * 0.023 ); //tamanoTexto = 20;
    tamanoAlerta = 10;//int( height * 0.013 ); //int( height * 0.023 ); //tamanoAlerta = 20;
  ...
  public String printlnError( String alerta ){
